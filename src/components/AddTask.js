...
import { FaRegListAlt, FaRegCalendarAlt, FaPlus } from 'react-icons/fa';
        ...
        <div className={showQuickAddTask ? 'add-task add-task__overlay' : 'add-task'} data-testid="add-task-comp">
            {showAddTaskMain && (
                <div
                    ...
                    role="button"
                >
                    <IconContext.Provider value={{ className: "add-task__plus" }}>
                        <FaPlus />
            ...
            {(showMain || showQuickAddTask) && (
                <div className="add-task__main" data-testid="add-task-main">
                    ...
                    <ProjectOverlay
                        designClass={showQuickAddTask ? 'project-overlay-modal' : 'project-overlay'}
                        setProject={setProject}
                        showProjectOverlay={showProjectOverlay}
                        setShowProjectOverlay={setShowProjectOverlay}
                    />
                    <TaskDate
                        designClass={showQuickAddTask ? 'task-date-modal' : 'task-date'}
                    ...
                    <input
                        ...
                        placeholder="e.g. Read every day #Learning"
                    />
                    <button
                        type="button"
